         ...
         <section className="portalHeaderSection">
               <div className="portalHeaderBox">
                  <div className="portalHeaderLogo">
                     ...
                     <Link href="">
                        <a title="">
                           <Image src={ClientPortalImg} width={50} height={36} className="imgImage" alt="" />
                           <Image src={ClientPoralTxt} className="imgText" width={118} height={33} alt="" />
                        </a>
                     </Link>
                  </div>
                  <div className="portalHeaderItembox">
                     ...
                     <div className="portalHeaderNotification">
                        ...
                        <div className="newNotificationList">
                           <ul>
                              <li>
                                 <p>Order has been placed. Your items are being shipped to our warehouse and will reach you very soon!</p>
                                 <span className="noteData">
                                    From <strong>Astris PME</strong> at <strong>12/02/2021 (13:00 PM)</strong>
                                    </span>
                              </li>
                              <li>
                                 <p>Order has been placed. Your items are being shipped to our warehouse and will reach you very soon!</p>
