...
import { FaSearch, FaPencilAlt, FaCaretLeft, FaCaretRight } from 'react-icons/fa';
import contactList from '../../src/datas/contacts.json'

export const getStaticProps = async () => {
    const res = "../src/datas/contacts.json"
    return{
       props: { contactList : [] }
    }
}
                        ...
                        <div className="myAccountsDetail">
                            <div className="sectionTitle spaceBetween">
                                ...
                                <div className="buttonHolder">
                                    <Link href="/addNewContact" passHref>
                                       <a className="button buttonYellow" title="Add New Address">Add New Contact</a>
                                    </Link>
                                </div>
                            </div>
                                        ...
                                        <table className="themeTable">
                                            ...
                                            <tbody>
                                                {contactList.map( contact => (
                                                    <tr key={contact.id}>
                                                        <td>{contact.name}<span className="colGreen">{contact.title}</span></td>
                                                        <td>{contact.phone}</td>
                                                        <td>{contact.email}</td>
                                                        <td>{contact.relation}</td>
                                                        <td><span className="colGreen fontBold">{contact.access}</span></td>
                                                        <td className="tdAction">
                                                            <Link href="/accEditContact">
