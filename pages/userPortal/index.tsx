                        ...
                        <ul>
                           <li>
                              <Link href="/myDetails" passHref>
                                 <a className="active" title="My Details">My Details</a>
                              </Link>
                           </li>
                           <li>
                              <Link href="/myAddress" passHref>
                                 <a title="My Addresses">My Addresses</a>
                              </Link>
                           </li>
                           <li>
                              <Link href="/passwordSecurity" passHref>
                                 <a title="Password & Security">Password & Security</a>
                              </Link>
                           </li>
                           <li>
                              <Link href="/accContact" passHref>
                                 <a title="Contacts">Contacts</a>
                              </Link>
                           </li>
                           <li>
                              <Link href="/myTherapists" passHref>
                                 <a title="My Therapists">My Therapists</a>
                              </Link>
                           </li>
                        </ul>
                     </div>
                        ...
                        <div className="myAccountsDetail">
                           <div className="sectionTitle spaceBetween">
                              ...
                              <div className="buttonHolder">
                                 <Link href="">
                                    <a className="button buttonYellow" title="Save Information">Save Information</a>
                                 </Link>
                              </div>
                           </div>
